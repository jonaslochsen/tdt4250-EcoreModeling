...
public class UniversityImpl extends MinimalEObjectImpl.Container implements University {
	...
	protected EClass eStaticClass() {
		return CoursePackage.Literals.UNIVERSITY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CoursePackage.UNIVERSITY__NAME, oldName, name));
	}
	...
	public EList<Faculty> getFaculties() {
		if (faculties == null) {
			faculties = new EObjectContainmentWithInverseEList<Faculty>(Faculty.class, this, CoursePackage.UNIVERSITY__FACULTIES, CoursePackage.FACULTY__UNIVERSITY);
		}
		return faculties;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CoursePackage.UNIVERSITY__FACULTIES:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getFaculties()).basicAdd(otherEnd, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CoursePackage.UNIVERSITY__NAME:
				return getName();
			case CoursePackage.UNIVERSITY__FACULTIES:
				return getFaculties();
		}
