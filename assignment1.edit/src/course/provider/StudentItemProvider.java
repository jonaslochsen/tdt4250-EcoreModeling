		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Student_evaluation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Student_evaluation_feature", "_UI_Student_type"),
				 CoursePackage.Literals.STUDENT__EVALUATION,
				 true,
				 false,
				 true,
				 null,
