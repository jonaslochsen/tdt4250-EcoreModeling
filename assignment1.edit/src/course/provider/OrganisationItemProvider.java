...
public class OrganisationItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CoursePackage.Literals.ORGANISATION__COURSE_COORDINATOR);
			childrenFeatures.add(CoursePackage.Literals.ORGANISATION__LECTURER);
			childrenFeatures.add(CoursePackage.Literals.ORGANISATION__TA);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CoursePackage.Literals.ORGANISATION__COURSE_COORDINATOR,
				 CourseFactory.eINSTANCE.createCourseCoordinator()));

		newChildDescriptors.add
			(createChildParameter
				(CoursePackage.Literals.ORGANISATION__LECTURER,
				 CourseFactory.eINSTANCE.createLecturer()));

		newChildDescriptors.add
			(createChildParameter
				(CoursePackage.Literals.ORGANISATION__TA,
				 CourseFactory.eINSTANCE.createTA()));
	}
