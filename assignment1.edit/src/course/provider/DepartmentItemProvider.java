...
/**
 * This is the item provider adapter for a {@link course.Department} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DepartmentItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CoursePackage.Literals.DEPARTMENT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addShortNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Department_shortName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Department_shortName_feature", "_UI_Department_type"),
				 CoursePackage.Literals.DEPARTMENT__SHORT_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CoursePackage.Literals.DEPARTMENT__COURSES);
			childrenFeatures.add(CoursePackage.Literals.DEPARTMENT__STUDY_PROGRAMS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CoursePackage.Literals.DEPARTMENT__COURSES,
				 CourseFactory.eINSTANCE.createCourse()));

		newChildDescriptors.add
			(createChildParameter
				(CoursePackage.Literals.DEPARTMENT__STUDY_PROGRAMS,
				 CourseFactory.eINSTANCE.createStudyProgram()));
	}
