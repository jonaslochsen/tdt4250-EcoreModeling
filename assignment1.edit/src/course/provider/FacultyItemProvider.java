...
/**
 * This is the item provider adapter for a {@link course.Faculty} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FacultyItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CoursePackage.Literals.FACULTY__NAME,
				 true,
				 false,
				 false,
	...
	protected void addShortNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Faculty_shortName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Faculty_shortName_feature", "_UI_Faculty_type"),
				 CoursePackage.Literals.FACULTY__SHORT_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CoursePackage.Literals.FACULTY__DEPARTMENTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CoursePackage.Literals.FACULTY__DEPARTMENTS,
				 CourseFactory.eINSTANCE.createDepartment()));
	}
